...
-(id)init {
    ...
    if (self = [super init]) {
        ...
        helpSurgery = @"Average Medicare reimbursement for Surgery is based on the 2013 Medicare MS-DRG 328 (Stomach, Esophageal and Duodenal Proc w/o CC/MCC); Weight 1.3848, multiplied by 2013 National Inpatient Prospective Payment System Average Base rate excluding capital add-on ($5,209.74) = Payment $7,709. Source: 2013 Medicare Acute Inpatient PPS Final Rule.    ";
        ...
        helpRadiology = @"Average Medicare Reimbursement for Radiology is estimated based on the average APC 276 (Level I Digestive Radiology) payment - $81.  Source: 2013 Medicare Hospital Outpatient Final Rule.";
        ...
        [assumptionsArray addObject:[[NSArray alloc] initWithObjects:@"Radiology Reimbursment", @"$81", @"Average Medicare Reimbursement for Radiology is estimated based on the average APC 276 (Level I Digestive Radiology) payment - $81.  Source: 2013 Medicare Hospital Outpatient Final Rule.",  nil]];
        [assumptionsArray addObject:[[NSArray alloc] initWithObjects:@"Anesthesia - Non Endoscopy Reimbursement", @"$154", @"Average Medicare Reimbursement for Anesthesia is estimated based on the 2013 Medicare Physician fee schedule for CPT 00790 (anesthesia for intraperitoneal procedures in upper abdomen incl. laparoscopy). 7 base units multiplied by 2013 National anesthesia conversion factor of $21.52 = Payment of $154.  Source: 2013 Medicare Physician Final Rule.",  nil]];
